...
(async function()
{
    ...
    //let result = await bla('example_models/cuboid5000.pcd', "/home/leo/Dropbox/19_SS/Master's Thesis/work files/scene scans/seestadt/universalrobot.pcd", 90, .02, .38);// vorletztes naja
    //let result = await bla('example_models/cuboid5000.pcd', "/home/leo/Dropbox/19_SS/Master's Thesis/work files/scene scans/seestadt/universalrobot2.pcd", 90, .02, .372);// perfect fit
    //let result = await bla('example_models/model5000.pcd', "/home/leo/Dropbox/19_SS/Master's Thesis/work files/scene scans/seestadt/universalrobot2.pcd", 90, .02, .372);// perfect fit
    let result = await bla('example_models/cylinder5000.pcd', "/home/leo/Dropbox/19_SS/Master's Thesis/work files/scene scans/seestadt/universalrobot2.pcd", 90, .02, .372);// NO fit ://
